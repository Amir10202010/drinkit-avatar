          ...
          <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-950 p-6 text-white shadow-2xl ring-1 ring-white/10">
            ...
            <div className="relative">
              ...
              <p className="mt-2 max-w-[28ch] text-sm leading-6 text-white/70">
                Зарегистрируйся, чтобы копить коины, открывать награды и соревноваться с друзьями.
              </p>
              ...
              <div className="mt-5 grid grid-cols-3 gap-3">
                ...
                <div className="rounded-2xl bg-white/10 p-3 text-center ring-1 ring-white/10 backdrop-blur">
                  ...
                  <p className="mt-1 text-xl font-bold">Now</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-5 rounded-[28px] bg-white p-6 shadow-sm ring-1 ring-slate-200">
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-slate-500">
                Создай свой аккаунт, чтобы начать собирать коны и участвовать в мини-играх.
              </p>
            </div>
            ...
            <form className="mt-6 space-y-4">
              ...
              <label className="flex items-start gap-3 rounded-2xl bg-slate-50 p-4 text-sm text-slate-600">
                ...
                />
                <span>
                  Я согласен с правилами сервиса и хочу получать бонусы за активность.
                </span>
              </label>
